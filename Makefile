...
CXX=/usr/bin/g++
CXXFLAGS=-g -Iunit/src -Itest -Iinih -Isrc -Wold-style-cast --std=c++11
...
# unit test on-demand from source. Hence, recursive make...
bin/libunit.a: bin
	export CXX
	$(MAKE) -C unit libunit.a
	cp unit/libunit.a bin

# This simply ensure that the test itself builds properly. It doesn't do
# anything, since if it builds, the test is a success.
bin/test-test: bin bin/libunit.a test/test.cpp
	${CXX} ${CXXFLAGS} test/test.cpp bin/libunit.a -o bin/test-test

bin/test-changes: bin/libunit.a obj/test-changes.o obj/model/changes.o
	${CXX} ${CXXFLAGS} obj/test-changes.o bin/libunit.a obj/model/changes.o -o bin/test-changes

obj/test-changes.o: obj test/changes.cpp
	${CXX} ${CXXFLAGS} -c test/changes.cpp -o obj/test-changes.o

bin/test-configparse: bin/libunit.a obj/test-configparse.o obj/ini.o obj/configparse.o obj/utils.o
	${CXX} ${CXXFLAGS} obj/test-configparse.o bin/libunit.a obj/configparse.o obj/ini.o obj/utils.o ${LINKERFLAGS} -o bin/test-configparse

obj/test-configparse.o: obj test/configparse.cpp
	${CXX} ${CXXFLAGS} -c test/configparse.cpp -o obj/test-configparse.o

bin/test-client-model: bin/libunit.a obj/test-client-model.o obj/model/client-model.o obj/model/changes.o obj/model/screen.o
	${CXX} ${CXXFLAGS} obj/test-client-model.o bin/libunit.a obj/model/client-model.o obj/model/changes.o obj/model/screen.o ${LINKER_FLAGS} -o bin/test-client-model
...
bin/test-focus-cycle: bin/libunit.a obj/test-focus-cycle.o obj/model/focus-cycle.o obj/logging/logging.o obj/logging/stream.o
	${CXX} ${CXXFLAGS} obj/test-focus-cycle.o obj/model/focus-cycle.o obj/logging/logging.o obj/logging/stream.o bin/libunit.a ${LINKER_FLAGS} -o bin/test-focus-cycle

obj/test-focus-cycle.o: obj
	${CXX} ${CXXFLAGS} -c test/focus-cycle.cpp -o obj/test-focus-cycle.o

bin/test-x-model: bin/libunit.a obj/test-x-model.o obj/model/x-model.o
	${CXX} ${CXXFLAGS} obj/test-x-model.o bin/libunit.a obj/model/x-model.o ${LINKER_FLAGS} -o bin/test-x-model

obj/test-x-model.o: obj test/x-model.cpp src/model/x-model.h
	${CXX} ${CXXFLAGS} -c test/x-model.cpp -o obj/test-x-model.o

bin/test-screen: bin/libunit.a obj/test-screen.o obj/model/screen.o
	${CXX} ${CXXFLAGS} obj/test-screen.o bin/libunit.a obj/model/screen.o ${LINKER_FLAGS} -o bin/test-screen

obj/test-screen.o: obj test/screen.cpp src/model/screen.cpp
	${CXX} ${CXXFLAGS} -c test/screen.cpp -o obj/test-screen.o

bin/test-utils: bin/libunit.a obj/test-utils.o obj/utils.o
	${CXX} ${CXXFLAGS} obj/test-utils.o bin/libunit.a obj/utils.o -o bin/test-utils

obj/test-utils.o: obj test/utils.cpp
	${CXX} ${CXXFLAGS} -c test/utils.cpp -o obj/test-utils.o
	
bin/test-unique-multimap: bin/libunit.a obj/test-unique-multimap.o
	${CXX} ${CXXFLAGS} obj/test-unique-multimap.o bin/libunit.a -o bin/test-unique-multimap
